    ...
    <div className="setting">
      ...
      <form className="settingForm">
        <div className="formItem">
          ...
          <input className="setting-input" type="file" id="img" hidden />
        </div>
        <div className="formItem">
          <label htmlFor="username"> Update your username :</label>
          <input className="setting-input" type="text" id="username" />
        </div>
        <div className="formItem">
        ...
        <div className="formItem">
          ...
          <input className="setting-input" type="password" id="password" />
        </div>
